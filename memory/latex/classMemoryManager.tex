...
{\em Virtual} & address to read from. \\
\hline
\end{DoxyParams}

\begin{DoxyRetVals}{Return values}
{\em value} & from mem\mbox{[}addr\mbox{]} \\
\hline
\end{DoxyRetVals}
...
Translate a virual address (P, d) to a physical address (f, d) 


\begin{DoxyParams}{Parameters}
{\em Virtual} & address to translate. \\
\hline
\end{DoxyParams}
